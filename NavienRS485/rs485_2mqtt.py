...
알파룸 = wallpad.add_device(device_name='알파룸', device_id='0e', device_subid='5f', child_devices = ["알파룸등"], device_class='light', optional_info=optional_info)
...
주방 = wallpad.add_device(device_name='주방', device_id='0e', device_subid='7f', child_devices = ["주방등", "식탁등"], device_class='light', optional_info=optional_info)
...
#주방전체.register_status(message_flag = '01', attr_name = 'availability', topic_class ='availability_topic', regex = r'()', process_func = lambda v: 'online')
...
주방.register_command(message_flag='41', attr_name='power', topic_class='command_topic', controll_id=['71','72'], process_func=lambda v: '01' if v == 'ON' else '00')
...
알파룸.register_command(message_flag='41', attr_name='power', topic_class='command_topic', controll_id=['51'], process_func=lambda v: '01' if v == 'ON' else '00')
