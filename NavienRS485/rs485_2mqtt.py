...
알파룸 = wallpad.add_device(device_name='끝방', device_id='0e', device_subid='5f', child_devices = ["알파룸등"], device_class='light', optional_info=optional_info)
...
끝방.register_command(message_flag='41', attr_name='power', topic_class='command_topic', controll_id=['51'], process_func=lambda v: '01' if v == 'ON' else '00')
